...
<body>
	...
	<div class="container">
		...
		<?php 
			$varIdFarmacia = $_REQUEST['idFarmacia'];
			...
			$query1 = "update farmacia set 
						fechaEntrega = now(),
						idMedicamento = '$varDescripcionMed',
						cantidadMedicamento = '$varCantidadMed',
						precioMedicamento = '$varPrecioMed',
						costoFarmacia = '$varMonto'
						where idFarmacia = '$varIdFarmacia'
					   ";
