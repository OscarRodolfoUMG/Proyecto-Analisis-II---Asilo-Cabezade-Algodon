...
<body>
	...
	<div class="container">
		<h3>Nuevos Resultados Examenes</h3>
		...
		<?php 
			...
			$query1 = 'select F.idFicha, C.idConsulta, U.userName, U.nombres, U.apellidos, U.fecha_nac, F.fechaVisita,  C.idConsulta, C.ordenExamenes
				from ficha_visita F
			...
			$query2 = 'select L.resultadoEx, L.costoLaboratorio
				from ficha_visita F
				inner join consulta C on F.idFicha = C.idFicha
			...
			echo '<form action = "add_laboratorio.php" method ="post">
			...
			<textarea name="descripcionEx"></textarea>

			<h5>Resultados Examenes</h5>
			<textarea name="resultadoEx"></textarea>
			...
			<div class="subcontainer">
				<div class="botones">
					...
					<input class="btn guardar" type="submit" name="" value="Agregar Resultados">
				</div>
			</div>
