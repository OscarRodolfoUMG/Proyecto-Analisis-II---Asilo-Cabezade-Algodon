...
<body>
	...
	<div class="container">
		<h3>Reporte Medicamentos Aplicados por Paciente</h3>
		

		<?php 
			$varUser = $_REQUEST['id'];

			echo '<h4>Reporte de Medicamentos: '.$varUser.'</h4>';
			...
			$query1 = 'select F.idFicha, U.username, U.nombres, U.apellidos, C.ordenMedicamentos, Fa.idMedicamento, F.fechaVisita 
						from usuario U 
			...
			while ($row = mysqli_fetch_assoc($resultado)){ 
				...
				echo '<td>'.$row['ordenMedicamentos'].'</td>';
