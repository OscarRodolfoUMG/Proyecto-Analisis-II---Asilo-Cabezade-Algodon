...
<body>
	...
	<div class="container">
		...
		<?php 
			...
			$query1 = 'select F.idFicha, F.username, F.fechaVisita 
				from ficha_visita F
				where F.username = "'.$varSesion.'"
			...
			while ($row = mysqli_fetch_assoc($resultado)){ 
				...
				echo "<td><a class='sen' href='ver_ficha_interno.php?id=".$row['idFicha']."' >Ver Ficha</a></td>";
				echo '</tr>';
				$i++;
			}
			echo "</table>";
