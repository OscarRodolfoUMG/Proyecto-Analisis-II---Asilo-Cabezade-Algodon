...
<body>
	...
	<div class="container">
		...
		<?php 
			...
			$query2 = 'select S.IdSolicitud, S.idEmpleado , U.userName, U.nombres, U.apellidos, U.fecha_nac, U.eMail, S.fechaSolicitud, S.aceptada from Usuario U inner join Solicitud S on U.userName = S.userName
				order by S.aceptada asc
			';
			...
			while ($row = mysqli_fetch_assoc($resultado)){ 
				...
				echo '<td>'.$varR.'</td>';
				echo "<td><a class='sen' href='ver_solicitud.php?
				id=".$row['userName']."&idEmpleado=".$varIdEmpleado."
				&idSol=".$row['IdSolicitud']."' >Ver Solicitud</a></td>";
				echo '</tr>';
				$i++;
			}
			echo "</table>";
