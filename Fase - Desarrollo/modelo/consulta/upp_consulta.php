...
<body>
	...
	<div class="container">
		...
		<?php 
			...
			$varDiagnostico = $_REQUEST['diagnostico'];
			$varOrdenEx = $_REQUEST['ordenEx'];
			$varOrdenMed = $_REQUEST['ordenMed'];
			$varObservaciones = $_REQUEST['observaciones'];
			...
			$query1 = "update consulta set 
						...
						ordenExamenes = '$varOrdenEx',
						ordenMedicamentos = '$varOrdenMed',
						observaciones = '$varObservaciones',
						costoConsulta = '$varCostoConsulta'
						where idConsulta = '$varIdConsulta'
					   ";
