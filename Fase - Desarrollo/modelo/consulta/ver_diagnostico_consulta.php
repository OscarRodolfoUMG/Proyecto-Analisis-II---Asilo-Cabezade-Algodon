	...
	<div class="container">
		...
		<?php 
			...
			$query1 = 'select F.idFicha, U.userName, U.nombres, U.apellidos, U.fecha_nac, F.fechaVisita, S.motivo, C.idConsulta, C.diagnostico, C.ordenExamenes, C.ordenMedicamentos, C.observaciones, C.costoConsulta
				...
				where F.idFicha = '.$vFicha.' AND C.idConsulta = '.$vConsulta.'
				';
			...
			<h5>ID Consulta:</h5> 
			<input readonly class="block" type="text" name="idConsulta" value="'.$vConsulta.'">

			<h5>Ordenes Examenes</h5>
			<textarea class="areaDiagnostico" name="ordenEx">'.$varOrdenesEx.'</textarea>
			...
			<textarea class="areaDiagnostico" name="ordenMed">'.$varOrdenMed.'</textarea>

			<h5>Diagnostico</h5>
			<textarea class="areaDiagnostico" name="diagnostico">'.$varDiagnostico.'</textarea>

			<h5>Observaciones</h5>
			<textarea class="areaDiagnostico" name="observaciones">'.$varObservaciones.'</textarea>
			...
			<div class="subcontainer">
				<div class="botones">
					...
					<input class="btn guardar" type="submit" name="" value="Actualizar Consulta">
				</div>
			</div>
