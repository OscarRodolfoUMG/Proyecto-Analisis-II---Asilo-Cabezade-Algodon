			      	...
			      	if(($varUsuario == $varUsuarioBD)&&($varContraseña == $varContraseñaBD)){
			      		switch ($varTypeBD) {
			      			case '1':
			      				...
			      				header("Location: ../modelo/interno/fichas_interno.php");
								exit;
			      				break;
			      			...
			      			case '4':
			      				session_start();
			      				$_SESSION['usuario'] = $varUsuarioBD;
			      				header("Location: ../modelo/fundacion/solicitudes_fundacion.php");
								exit;
			      				break;
			      		    ...
			      		    $puesto = mysqli_query ($conexionDB, $query) 
								       ...
								       $varIdEmpleado = $row['idEmpleado'];
												...
												switch ($varPuestoBD) {
													...
													case '2':
															$_SESSION['idEmpleado'] = $varIdEmpleado;
															header("Location: ../modelo/farmacia/fichas_farmacia.php");
														break;

													case '3':
															$_SESSION['idEmpleado'] = $varIdEmpleado;
															header("Location: ../modelo/laboratorio/fichas_laboratorio.php");
														break;
