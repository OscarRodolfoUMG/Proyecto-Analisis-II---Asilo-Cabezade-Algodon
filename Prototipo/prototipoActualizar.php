...
<body>
	...
	<div class="head"> 
		...
		<div class="container">
		<h2>Actualizar - Ingrese ID</h2>

		
		<!--Formulario para buscar el id de la ficha para buscarla y posteriormente actualizarla-->
		<form action = "update_prototipo.php" method ="post">

			<!--Contenedor del campo id de la ficha para ingresarla-->
			<div class="pre">
				<input class="bar" type="text" name="id_interno">
			</div>
			...
			<div class="subcontainer botones">
				<!--Boton para preparar el id en el archivo "upp_prototipo.php"-->
