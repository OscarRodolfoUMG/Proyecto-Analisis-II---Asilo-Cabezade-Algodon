...
-- Tiempo de generación: 27-10-2022 a las 02:18:46
...
INSERT INTO `consulta` (`idConsulta`, `idFicha`, `diagnostico`, `ordenExamenes`, `ordenMedicamentos`, `observaciones`, `costoConsulta`) VALUES
(1, 1, 'Parcialmente Adolorido', 'Examen de Sangre y Examen de Eses', 'Ubuprofeno', 'Ninguna', 540.6),
(2, 2, '', 'Prueba de Fuerza\r\nExamen de Sangre', '', 'Sin observaciones', 100.5),
(4, 3, 'Estreñimientos por tacos', 'Examen de Sangre', 'Tomar dos yodoclorinas por 2 semanas', 'Se espera el Examen', 800),
(5, 4, 'Fatiga por el estres', 'Examenes importantes', 'Ibuprofeno', 'Volver a diagnosticar en 2 meses', 500);
...
INSERT INTO `empleado` (`idEmpleado`, `userName`, `idEspecialidad`, `idPuesto`) VALUES
(8, 'lab-erick', 5, 3),
(9, 'Carol', 6, 1),
(10, 'Alex', 7, 1),
(12, 'farm_Oto', 5, 2);
...
INSERT INTO `farmacia` (`idFarmacia`, `idFicha`, `fechaEntrega`, `idMedicamento`, `cantidadMedicamento`, `precioMedicamento`, `costoFarmacia`) VALUES
(1, 1, '2022-10-07', 'Ibuprofeno 400mg', 15, 3.25, 48.75),
(2, 3, '2022-10-14', '28 yodoclorinas', 28, 2.5, 70),
(3, 4, '2022-10-20', 'Ibuprofeno 400mg', 8, 5.5, 44);
...
--
-- Volcado de datos para la tabla `ficha_visita`
--

INSERT INTO `ficha_visita` (`idFicha`, `idSolicitud`, `userName`, `idEmpleado`, `fechaVisita`, `monto`) VALUES
(1, 4, 'RodDod', 10, '2022-10-30 03:00:00', 1289.35),
(2, 5, 'OrlandoC', 10, '2022-10-21 18:54:00', NULL),
(3, 6, 'GiselF', 10, '2022-10-29 13:43:00', 1070.5),
(4, 7, 'ClaraC', 10, '2022-10-30 09:58:00', 620.2),
(5, 7, 'ClaraC', 10, '2022-11-01 23:53:00', NULL);
...
INSERT INTO `laboratorio` (`idLaboratorio`, `idFicha`, `fechaExamen`, `descripcionEx`, `resultadoEx`, `costoLaboratorio`) VALUES
(12, 1, '2022-10-07', 'Se recibieron las muestras de Sangre y Eses', 'Examen de Eses =  positivo a eColi\r\nExamen de Sangre = B+', 700),
(13, 3, '2022-10-14', 'Se realizaron los ensayos con tubos XD', 'A+', 200.5),
(14, 4, '2022-10-20', 'Test de Fuerza', 'Presión arterial normal', 100.5);
...
INSERT INTO `movimiento_cuenta` (`idMovimiento`, `idCuenta`, `idFicha`, `idTipoMovimiento`, `motivoMovimiento`, `montoMovimiento`, `fechaMovimiento`) VALUES
(1, 10, 4, 2, 'Cobro VisitaMedica', 620.2, '2022-10-21'),
(2, 1, NULL, 1, 'Donado por Oscar Rodolfo Chávez 78431334684', 200, '2022-10-21'),
(3, 1, NULL, 1, 'Donado por RAul Ordoñez 78945124578', 250.3, '2022-10-22'),
(4, 1, NULL, 2, 'Pago de Internet Se pago en oficina', 250.3, '2022-10-24'),
(6, 2, NULL, 2, 'Pago Fundacion ', 250, '2022-10-25'),
(7, 2, NULL, 2, 'Pago Fundacion ', 250, '2022-10-25'),
(8, 10, NULL, 2, 'Mensualidad octubre', 200, '2022-10-26'),
(9, 10, NULL, 1, 'Pago Mensualidad octubre User: ClaraC T.Carla C 7894564512', 150, '2022-10-26'),
(10, 1, NULL, 1, 'Donado por Carlos Martines Algurado Lopez 784313876461', 150, '2022-10-26'),
(11, 2, NULL, 2, 'Pago Fundacion ', 100, '2022-10-26'),
(12, 2, NULL, 2, 'Pago Fundacion ', 100, '2022-10-26'),
(13, 10, NULL, 2, 'Mensualidad noviembre', 200, '2022-10-26');
...
INSERT INTO `solicitud` (`idSolicitud`, `userName`, `eMail`, `idEmpleado`, `fechaSolicitud`, `aceptada`, `motivo`, `enfermeroAux`) VALUES
(1, 'mario1', 'farofil992@migonom.com', 9, '2022-10-03', 0, 'Sudoracion e hyperventilacion nocturna', 'Jaime Polanco'),
(4, 'RodDod', 'rodol_oscar@hotmail.com', 10, '2022-10-05', 0, 'Dolor de Cabeza Cronico', 'Jaime Polanco'),
(5, 'OrlandoC', 'rodol_oscar@hotmail.com', 10, '2022-10-08', 0, 'Problemas del Corazon', 'Gabriel Seguro'),
(6, 'GiselF', 'rodol_oscar@hotmail.com', 10, '2022-10-14', 0, 'Diarrea Cronica', 'Jaime Polanco'),
(7, 'ClaraC', 'clara_c@hotmail.com', 10, '2022-10-20', 1, 'Dolor de Estomago Severo', 'Gabriel Seguro');
...
('Alex', 'Rex', 'Alexander Daniel', 'Castillo Hond', 5, 'Ninguno', '0000-00-00'),
('Asilo', 'Asilo@77', 'Cabeza', 'de Algodon', 3, 'asilocabezadealgodon_1699@hotmail.com', NULL),
('Carol', 'Farol', 'Carolina Almendra', 'Trujillo Ovalle', 5, 'Ninguno', '0000-00-00'),
('ClaraC', 'Delfin', 'Clara Marisol', 'Caballas Linares', 1, 'clara_c@hotmail.com', '1966-07-07'),
('Daniel98', '12345', 'Daniel', 'Guillen', 1, 'daniel83@gmail.com', '2022-10-28'),
('farm_Oto', 'Farm@77', 'Oto Raul', 'Linares', 5, 'Ninguno', '0000-00-00'),
('Fundacion', 'Fundacion@77', 'Fundacion', '', 4, 'fundacion_1699@hotmail.com', NULL),
('GiselF', 'Gisel@77', 'Gisel', 'Fernandez', 1, 'rodol_oscar@hotmail.com', '1962-02-08'),
('lab-erick', 'lab', 'Erick Eduardo', 'Feliciano', 5, 'Ninguno', '0000-00-00'),
('mario1', '12345', 'Mario', 'Rodas', 1, 'farofil992@migonom.com', '2022-10-06'),
('MedicoGeneral', 'Medico@77', 'Medico', 'General', 2, 'medicogeneral_1699@hotmail.com', NULL),
('OrlandoC', 'Orlando@77', 'Orlando', 'Castillo', 1, 'rodol_oscar@hotmail.com', '1980-07-10'),
('RodDod', 'Zapato', 'Oscar Rodolfo', 'Chávez Camey', 1, 'rodol_oscar@hotmail.com', '2019-04-16');
